...
function YourTasks({ tasks, deleteTask, selectTaskForUpdate }) {
  ...
  return (
    <div className="yourTask">
      {selectedTask ? (
        // Task Detail View
        <div style={{ padding: "1rem" ,width:"100%",backgroundColor:"rgba(0,0,0,0.7)",borderRadius:"5%"}}>
          <button
            ...
            style={{
              ...
              border: "none",
              borderRadius: "5px",
              backgroundColor: "rgb(107, 219, 156)",
              color: "#fff",
              cursor: "pointer",
              marginBottom: "1rem",
            }}
        ...
        <br/>
          ...
          <ul style={{ listStyleType: "none", padding: "0px",margin:"0px",width:"100%" }}>
              ...
              filteredTasks.map((task) => (
                <li
                  ...
                  style={{
                    ...
                    alignItems: "center",
                    cursor: "pointer",
                    backgroundColor:"rgba(180,225,190,0.66)",
                    width:"100%"
                  }}
